...
export class Web {
    ...
    alerte() {
        ...
        try {
            ...
            wasm.web_alerte(retptr, this.__wbg_ptr);
     ...
     */
    key(k, ctrl) {
        const ptr0 = passStringToWasm0(k, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    ...
    render(cols, rows) {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.web_render(retptr, this.__wbg_ptr, cols, rows);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('affut_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
